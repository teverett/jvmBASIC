   ...
   public boolean execute(GenerationContext generationContext) throws Exception {
      try {
         ...
         if (generationContext.getParseTree().getChildCount() == 4) {
            ...
            generationContext.getMethodVisitor().visitMethodInsn(Opcodes.INVOKESTATIC, "com/khubla/jvmbasic/jvmbasicrt/StringFunctions", "STR", "(Lcom/khubla/jvmbasic/jvmbasicrt/Value;)Ljava/lang/String;");
