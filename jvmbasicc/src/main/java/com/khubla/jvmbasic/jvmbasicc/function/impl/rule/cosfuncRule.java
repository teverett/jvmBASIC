...
public class cosfuncRule extends BaseFunction {
   ...
   public boolean execute(GenerationContext generationContext) throws Exception {
      try {
         ...
         generationContext.getMethodVisitor().visitMethodInsn(Opcodes.INVOKESTATIC, RTLHelper.JASIC_RUNTIME_MATH, "COS", "(Lcom/khubla/jvmbasic/jvmbasicrt/Value;)Ljava/lang/Double;");
