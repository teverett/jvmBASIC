...
/**
 * This class provides an empty implementation of {@link jvmBasicListener}, which can be extended to create a listener which only needs to handle a subset of the available methods.
 */
public class jvmBasicBaseListener implements jvmBasicListener {
    ...
    */
   @Override
   public void enterForstmt1(jvmBasicParser.Forstmt1Context ctx) {
   }
    ...
    */
   @Override
   public void enterForstmt2(jvmBasicParser.Forstmt2Context ctx) {
   }
    ...
    */
   @Override
   public void enterNextstmt(jvmBasicParser.NextstmtContext ctx) {
   }
    ...
    */
   @Override
   public void exitForstmt1(jvmBasicParser.Forstmt1Context ctx) {
   }
    ...
    */
   @Override
   public void exitForstmt2(jvmBasicParser.Forstmt2Context ctx) {
   }
    ...
    */
   @Override
   public void exitNextstmt(jvmBasicParser.NextstmtContext ctx) {
   }
