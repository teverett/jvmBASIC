 ...
 * @author tome
 */
public class exponentExpressionRule extends BaseFunction {
   @Override
   public boolean execute(GenerationContext generationContext) throws JVMBasicFunctionException {
      try {
         ...
         if (generationContext.getParseTree().getChildCount() == 3) {
            ...
            generationContext.getMethodVisitor().visitMethodInsn(Opcodes.INVOKESTATIC, RTLHelper.JASIC_RUNTIME_MATH, "EXP", "(Lcom/khubla/jvmbasic/jvmbasicrt/Value;)Ljava/lang/Double;", false);
